function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "./assets/sprites/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "./assets/sprites/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "./assets/sprites/but_start.png");
    ...
    this.attachSprites = function () {
        ...
        _oButStart = new CTextButton(CANVAS_WIDTH/2, CANVAS_HEIGHT/2+40, oSprite, '', "Arial", "#000", 50, _oContainer);        
