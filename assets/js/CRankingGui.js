    ...
    this._initBibs = function(aNames){
        ...
        for(var i=0;i<NUM_HORSES;i++){
            ...
            var oNameText =  new CTLText(oContainerBib, 
                    -5, 2, 60, 12, 
                    EngagedNation.Config.Game.text_rank_panel_font_size, "right", EngagedNation.Config.Game.text_rank_panel_font_color, EngagedNation.Config.Game.text_rank_panel_font_family, 1,
                    0, 0,
